...
interface MultiSelectProps
  ...
  /** The controlled selected values for the component. */
  value: string[];
  ...
  /**
   * Callback function for handling search input changes.
   * When provided, the component will not filter options internally.
   */
